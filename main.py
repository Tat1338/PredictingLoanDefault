"""
================= Predicting Loan Default — Exam Project =================
...
dependents/mortgage breakdowns, correlation heatmap, missingness, high-corr);
...
def write_model_card(df: pd.DataFrame, metrics: dict):
    ...
    lines = []
    lines.append("# Model Card: Loan Serious-Late Prediction\n")
